            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[
                        ...
                        [
                            'name' => 'Detail Sarana & Prasarana',
                            'url' => '/facilities' . '/' . $facilities->slug,
                        ],
                    ]"></x-breadcrumb>
                </div>
            </div>
                    ...
                    @if ($facilities->count() > 0)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $facilities->created_at->format('d F Y') }}
                                    ({{ $facilities->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            <div class="relative w-full h-auto mt-2 mb-5 mr-5 overflow-hidden lg:mb-0"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $facilities->image) }}" alt="{{ $facilities->title }}"
