                    ...
                    @if ($ppdb)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $ppdb->created_at->format('d F Y') }}
                                    ({{ $ppdb->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            <div class="relative w-full h-auto mt-2 mb-5 mr-5 overflow-hidden lg:mb-0"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $ppdb->image) }}" alt="{{ $ppdb->title }}"
                ...
                <div class="md:w-[28%] p-5 md:border-l-2 md:border-greenMain md:border-opacity-60">
                    ...
                    @else
                        <div
                            ...
                            <svg class="w-16 h-16 mx-auto mb-4 text-amber-500 fill-amber-500" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 -960 960 960">
                                <path
                    ...
                    @else
                    {
                        ...
                        @mouseleave="startAutoSlide" class="mt-4 overflow-hidden bg-white border-2 border-gray-100 rounded-sm">
