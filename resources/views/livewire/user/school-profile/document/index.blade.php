    ...
    <div x-data="{
        ...
        <div class="relative h-96 mb-8 overflow-hidden bg-gradient-to-b from-stone-900 to-greenMain">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[['name' => 'Beranda', 'url' => '/'], ['name' => 'Dokumen', 'url' => '/documents']]"></x-breadcrumb>
                </div>
            </div>
        </div>
        <!-- Main Content -->
                    ...
                    @if ($document)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span
                                    class="ml-2 text-xs text-gray-600">{{ $document->created_at->format('d F Y') }}
                                    ({{ $document->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                    ...
                    @else
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <h2 class="mb-2 text-2xl font-semibold text-black font-merriweather">Tidak Ada Dokumen
                                </h2>
                                <p class="text-gray-600 font-jakarta">Saat ini belum ada dokumen yang
                                    tersedia.
