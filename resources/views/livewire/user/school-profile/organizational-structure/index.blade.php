...
<div>
    <div x-data="{
        ...
        <div class="relative h-96 mb-8 overflow-hidden bg-gradient-to-b from-stone-900 to-greenMain">
            <!-- Animated Overlay -->
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[
                        ['name' => 'Beranda', 'url' => '/'],
                        ['name' => 'Struktur Organisasi', 'url' => '/organizationalstructure'],
                    ]"></x-breadcrumb>
                </div>
            </div>
        </div>
        <div class="container mx-auto px-8 py-12 mb-12" x-data="{ zoomed: false, mouseX: 0, mouseY: 0, imageWidth: 0, imageHeight: 0 }"
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-[72%]">
                    @if ($organizationalstructure)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $organizationalstructure->created_at->format('d F Y') }}
                                    ({{ $organizationalstructure->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            <div class="relative overflow-hidden  lg:mb-0 mt-2 w-full mb-5 mr-5 h-auto"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $organizationalstructure->image) }}" alt="{{ $organizationalstructure->title }}"
                            ...
                            <span class="prose break-words indent-8 text-justify">
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="mb-2 text-2xl font-semibold text-black font-merriweather">Tidak Ada Struktur Organisasi</h2>
                        <p class="text-gray-600 font-jakarta">Saat ini belum ada struktur organisasi yang
                            tersedia.
                ...
                <div class="md:w-[28%] p-5 md:border-l-2 md:border-greenMain md:border-opacity-60">
                    ...
                    @else
                    {
                        ...
                        <div class="relative aspect-[4/3]">
                            ...
                            <button @click="prev(); resetAutoSlide()"
                                class="absolute top-20 bottom-20 left-0 w-1/4 group focus:outline-none">
                                <span
                            ...
                            <button @click="next(); resetAutoSlide()"
                                class="absolute top-20 bottom-20 right-0 w-1/4 group focus:outline-none">
                                <span
                    ...
                    @else
                        <div
                            class="py-8 px-2 mt-4 overflow-hidden text-center bg-white border border-gray-300 rounded-md border-opacity-60">
                            <svg class="w-16 h-16 mx-auto mb-4 text-amber-500 fill-amber-500"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                <path
