            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[
                        ['name' => 'Beranda', 'url' => '/'],
                        ['name' => 'Sambutan Kepala Sekolah', 'url' => '/intro'],
                    ]"></x-breadcrumb>
                </div>
            </div>
        </div>
                ...
                <div class="md:w-[72%]">
                    @if ($intro)
                        <div class="font-jakarta">
                            ...
                            <div class="relative overflow-hidden w-1/3 lg:mb-0 mt-2 float-start mb-5 mr-5 h-auto"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $intro->image) }}" alt="{{ $intro->title }}"
