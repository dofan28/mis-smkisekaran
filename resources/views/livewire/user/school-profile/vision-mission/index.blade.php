            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[
                        ['name' => 'Beranda', 'url' => '/'],
                        ['name' => 'Visi dan Misi', 'url' => '/visionmission'],
                    ]"></x-breadcrumb>
                </div>
            </div>
        </div>
                    ...
                    @if ($visionmission)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $visionmission->created_at->format('d F Y') }}
                                    ({{ $visionmission->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            <div class="relative overflow-hidden  lg:mb-0 mt-2 w-full mb-5 mr-5 h-auto"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $visionmission->image) }}" alt="{{ $visionmission->title }}"
                    ...
                    @else
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <h2 class="mb-2 text-2xl font-semibold text-black font-merriweather">Tidak Ada Visi dan
                                    Misi</h2>
                                <p class="text-gray-600 font-jakarta">Saat ini belum ada visi dan misi yang
                                    tersedia.
