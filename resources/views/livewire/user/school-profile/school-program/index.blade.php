            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center text-white uppercase">
                ...
                <div class="!text-3xl ">
                    <x-breadcrumb :breadcrumbs="[
                        ['name' => 'Beranda', 'url' => '/'],
                        ['name' => 'Program Sekolah', 'url' => '/schoolprogram'],
                    ]"></x-breadcrumb>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-[72%]">
                    @if ($schoolprogram)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $schoolprogram->created_at->format('d F Y') }}
                                    ({{ $schoolprogram->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            <div class="relative overflow-hidden  lg:mb-0 mt-2 w-full mb-5 mr-5 h-auto"
                                x-on:mouseleave="zoomed = false" x-ref="imageContainer">
                                <img src="{{ asset('storage/' . $schoolprogram->image) }}" alt="{{ $schoolprogram->title }}"
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="mb-2 text-2xl font-semibold text-black font-merriweather">Tidak Ada Program
                            Sekolah
                        </h2>
                        <p class="text-gray-600 font-jakarta">Saat ini belum ada program sekolah yang
                            tersedia.
