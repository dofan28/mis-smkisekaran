                    ...
                    @if ($article)
                        <div class="font-jakarta">
                            <div class="flex items-center font-jakarta ">
                                ...
                                <span class="ml-2 text-xs text-gray-600">{{ $article->created_at->format('d F Y') }}
                                    ({{ $article->created_at->locale('id')->diffForHumans() }})
                                </span>
                            </div>
                            ...
                            <h2
                                ...
                                {{ $article->title }}</h2>
                            <div
                                class="bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded-full inline-block whitespace-nowrap">
                    ...
                    <h2
                            ...
                            @forelse ($articles as $article)
                                <li wire:key='{{ $article->id }}'>
                                    <div
                                        ...
                                        <a wire:navigate.hover href="/article/{{ $article->slug }}"
                                            class="mt-5 text-lg font-semibold uppercase break-words text-lime-600 hover:text-lime-700 font-merriweather line-clamp-2">
                                            {{ $article->title }}
                                        </a>
                                        ...
                                        <div class="flex items-center justify-between mt-4">
                                            ...
                                            <a href="/article/{{ $article->slug }}" wire:navigate.hover
                            ...
                            @empty
                                <div
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h2 class="mb-2 text-xl font-semibold text-black font-merriweathe">Tidak Ada
                                            Artikel
                                        </h2>
                        ...
                        @if ($all_articles->count() > 0)
                            <div class="flex justify-center mt-4 text-sm font-jakarta">
                                <p>Menampilkan <span class="font-semibold">{{ $articles->count() }}</span> item
                                    dari
                                    <span class="font-semibold">{{ $all_articles->count() }}</span> hasil
                                </p>
                            </div>
                        @endif
