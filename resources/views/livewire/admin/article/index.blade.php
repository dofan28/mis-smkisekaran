<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/articles/create"
                class="flex items-center px-3 py-2 space-x-2 font-semibold text-white transition duration-300 ease-in-out transform rounded-lg shadow-lg w-36 bg-amber-500 hover:bg-amber-500 hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                </svg>
                <span class="text-sm font-jakarta">Buat Artikel</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                                ...
                                <tr wire:key='{{ $article->id }}'
                                        ...
                                        <div class="flex items-center justify-center font-jakarta">
                                            ...
                                            @elseif ($article->status === 'archived')
                                                <span
                                                    ...
                                                    <svg class="w-4 h-4 mr-1 fill-gray-600"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                                                        <path
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/articles/{{ $article->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/articles/{{ $article->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'artikel ' . $article->title . ''" :data="$article">
                    ...
                    <div class="sm:hidden">
                        @foreach ($articles as $article)
                            <div class="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                <div class="p-4">
                                    <h3 class="mb-2 text-lg line-clamp-2 font-semibold text-gray-800">{{ $article->title }}</h3>
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $article->title . ''" :data="$article">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data artikel tidak tersedia. Silakan buat <a wire:navigate href="/admin/articles/create"
                                class="underline text-greenMain">artikel baru</a>.</h3>
                    </div>
                @endif
            </div>
