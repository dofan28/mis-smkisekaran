            ...
            <div class="flex items-center justify-center ">
                <div class="w-full mx-auto bg-white">
                    <form wire:submit='update'>
                        <div class="mb-5">
                            <label for="category_id" class="block mb-1 font-semibold text-gray-800 font-jakarta">
                                Kategori
                            </label>
                            <div class="flex items-center">
                                <select wire:click="$refresh" wire:model='category_id' name="category_id"
                                    id="category_id" placeholder="Masukkan jenis"
                                    class="w-full rounded-md border  appearance-none bg-white py-3 px-5 text-sm  text-gray-600 outline-none focus:border-greenMain font-jakarta focus:shadow-md @error('category_id') border-red-500 @enderror"
                                    required autofocus>
                                ...
                                <div x-data>
                                    <button type="button"
                                        @click="$dispatch('set-open', true); console.log('Button clicked');"
                                        class="px-2 py-2 ml-3 text-white rounded-lg bg-greenMain hover:bg-stone-900 focus:bg-stone-900 hover:text-white focus:outline-none focus:ring ring-greenMain">
                                                ...
                                                <template x-if="fileName">
                                                    <div class="mt-2">
                                                        ...
                                                        <p class="text-sm text-gray-600 font-jakarta">Ukuran File:
                                                            <span x-text="fileSize"></span> KB</p>
                                                    </div>
                                                </template>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Edit Artikel</span>
