<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        [
            'name' => 'Mengelola Pengumuman',
            'url' => '/admin/announcements',
        ],
        [
            'name' => 'Edit Halaman',
            'url' => '/admin/announcements/' . $announcement->slug . '/edit',
        ],
    ]"></x-breadcrumb>
    <main class="py-10">
                    ...
                    <form wire:submit='update'>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Edit Pengumuman</span>
    ...
    <script>
        document.addEventListener('livewire:navigated', () => {
            ...
            title.addEventListener('change', function() {
                fetch('/admin/announcements/checkSlug?title=' + title.value)
