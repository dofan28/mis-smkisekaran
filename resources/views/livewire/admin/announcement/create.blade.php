                    ...
                    <form wire:submit='save'>
                        ...
                        <div class="mb-5">
                            ...
                            <select wire:model='status' name="status" id="status" placeholder="Masukkan jenis"
                                class="w-full rounded-md border  appearance-none bg-white py-3 px-5 text-sm  text-gray-600 outline-none focus:border-greenMain font-jakarta focus:shadow-md @error('status') border-red-500 @enderror" required>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Buat Pengumuman</span>
