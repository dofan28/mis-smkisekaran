<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/announcements/create"
                ...
                <span class="text-sm font-jakarta">Buat Pengumuman</span>
            </a>
            ...
            <div class="mt-5 overflow-x-auto">
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($announcements as $announcement)
                                <tr wire:key='{{ $announcement->id }}'
                                    ...
                                    <td class="flex items-center justify-center px-4 py-3 border border-gray-100">
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="flex items-center justify-center">
                                            @if ($announcement->status === 'inactive')
                                                <span
                                                    class="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold text-red-600 rounded-full font-jakarta bg-red-50">
                                            ...
                                            @elseif ($announcement->status === 'active')
                                                <span
                                                    class="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold text-green-600 rounded-full font-jakarta bg-green-50">
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/announcements/{{ $announcement->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/announcements/{{ $announcement->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $announcement->title . ''" :data="$announcement">
                    ...
                    <div class="sm:hidden">
                        @foreach ($announcements as $announcement)
                            <div class="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                <div class="p-4">
                                    <h3 class="mb-2 text-lg line-clamp-2 font-semibold text-gray-800">{{ $announcement->title }}</h3>
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data pengumuman tidak tersedia. Silakan buat <a wire:navigate
                                href="/admin/announcements/create" class="underline text-greenMain">pengumuman
                                baru</a>.</h3>
                    </div>
                @endif
            </div>
