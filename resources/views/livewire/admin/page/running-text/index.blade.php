<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/pages/runningText/create"
                ...
                <span class="text-sm font-jakarta">Buat Teks Berjalan</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                @if ($pageRunningTexts->isNotEmpty())
                    <!-- Desktop version -->
                    <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($pageRunningTexts as $pageRunningText)
                                <tr wire:key='{{ $pageRunningText->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {{ $pageRunningText->title }}
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {{ $pageRunningText->type }}
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {!! $pageRunningText->content !!}
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate
                                                href="/admin/pages/runningText/{{ $pageRunningText->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate
                                                href="/admin/pages/runningText/{{ $pageRunningText->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'halaman Teks Berjalan ' . $pageRunningText->title . ''" :data="$pageRunningText">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        <div class="flex space-x-2">
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $pageRunningText->title . ''" :data="$pageRunningText">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data halaman teks berjalan tidak tersedia. Silakan buat <a wire:navigate
                                href="/admin/pages/runningText/create" class="underline text-greenMain">halaman
                                teks berjalan baru</a>.</h3>
                    </div>
                @endif
            </div>
        </div>
        <x-pagination :items="$pageRunningTexts" />
    </main>
</div>
