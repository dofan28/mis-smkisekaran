<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Edit Halaman Kompetensi Keahlian',
            'url' => '/admin/pages/competencySkill/' . $pageCompetencySkill->slug . '/edit',
        ],
    ]"></x-breadcrumb>
                    ...
                    <form wire:submit='update'>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Edit Halaman Kompetensi Keahlian</span>
