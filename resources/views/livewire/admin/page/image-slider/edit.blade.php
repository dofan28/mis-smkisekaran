<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Mengelola Halaman Gambar Slider',
            'url' => '/admin/pages/imageSlider',
        ],
        [
            'name' => 'Edit Halaman Gambar Slider',
            'url' => '/admin/pages/imageSlider/' . $pageImageSlider->slug . '/edit',
        ],
    ]"></x-breadcrumb>
                    ...
                    <form wire:submit='update'>
                        ...
                        <div class="mb-5">
                            ...
                            <select wire:model='type' name="type" id="type" placeholder="Masukkan jenis"
                                ...
                                <option value="slider-1">Gambar Slider 1</option>
                                <option value="slider-2">Gambar Slider 2</option>
                                <option value="slider-3">Gambar Slider 3</option>
                            </select>
                            @error('type')
                                <p class="text-xs italic text-red-500 font-jakarta">{{ $message }}</p>
                            @enderror
                            ...
                            <div x-data="{ dragging: false, fileName: '', fileSize: 0 }" class="relative w-full">
                                <div class="items-center justify-center mx-auto">
                                    <label :class="{ 'border-greenMain': dragging, 'border-gray-300': !dragging }"
                                        ...
                                        @endif
                                        @if (!$newImage && $image)
                                            <img src="{{ asset('storage/' . $pageImageSlider->image) }}">
                                        @endif
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Edit Halaman Gambar Slider</span>
