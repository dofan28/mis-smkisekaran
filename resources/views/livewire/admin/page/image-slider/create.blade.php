<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Buat Halaman Gambar Slider',
            'url' => '/admin/pages/imageSlider/create',
        ],
    ]"></x-breadcrumb>
    <main class="py-10">
                    ...
                    <form wire:submit='save'>
                        ...
                        <div class="mb-5">
                            ...
                            <div x-data="{ dragging: false, fileName: '', fileSize: 0 }" class="relative w-full">
                                <div class="flex sm:flex-row flex-col items-center justify-center mx-auto">
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Buat Gambar Slider</span>
