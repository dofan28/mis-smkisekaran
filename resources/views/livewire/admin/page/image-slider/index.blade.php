<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/pages/imageSlider/create"
                ...
                <span class="text-sm font-jakarta">Buat Gambar Slider</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                @if ($pageImageSliders->isNotEmpty())
                <!-- Desktop version -->
                    <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($pageImageSliders as $pageImageSlider)
                                <tr wire:key='{{ $pageImageSlider->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {{ $pageImageSlider->title }}
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {{ $pageImageSlider->type }}
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {!! $pageImageSlider->content !!}
                                        </div>
                                    </td>
                                    <td class="flex justify-center px-4 py-3 border border-gray-100">
                                        <img src="{{ asset('storage/' . $pageImageSlider->image) }}"
                                            ...
                                            alt="{{ $pageImageSlider->title }}">
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/pages/imageSlider/{{ $pageImageSlider->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/pages/imageSlider/{{ $pageImageSlider->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'halaman gambar slider ' . $pageImageSlider->title . ''" :data="$pageImageSlider">
                    ...
                    <div class="sm:hidden">
                        @foreach ($pageImageSliders as $pageImageSlider)
                            <div class="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                <div class="p-4">
                                    <h3 class="mb-2 text-lg line-clamp-2 font-semibold text-gray-800">{{ $pageImageSlider->title }}</h3>
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        <div class="flex space-x-2">
                                            <a wire:navigate
                                                href="/admin/pages/imageSlider/{{ $pageImageSlider->slug }}/edit">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $pageImageSlider->title . ''" :data="$pageImageSlider">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data halaman gambar slider tidak tersedia. Silakan buat <a wire:navigate href="/admin/pages/imageSlider/create"
                                class="underline text-greenMain">halaman gambar slider baru</a>.</h3>
                    </div>
                @endif
            </div>
        </div>
        <x-pagination :items="$pageImageSliders" />
    </main>
</div>
