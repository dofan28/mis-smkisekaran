<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Mengelola Halaman Sarana & Prasarana',
            'url' => '/admin/pages/facilities',
        ],
    ]"></x-breadcrumb>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/pages/facilities/create"
                ...
                <span class="text-sm font-jakarta">Buat Sarana & Prasarana</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                @if ($pageFacilitiess->isNotEmpty())
                <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($pageFacilitiess as $pageFacilities)
                                <tr wire:key='{{ $pageFacilities->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="break-words line-clamp-2">
                                            {!! $pageFacilities->content !!}
                                        </div>
                                    </td>
                                    <td class="flex justify-center px-4 py-3 border border-gray-100">
                                        <img src="{{ asset('storage/' . $pageFacilities->image) }}"
                                            class="object-cover object-center h-24 border-2 border-gray-400 rounded-md shadow-md"
                                            alt="{{ $pageFacilities->title }}">
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/pages/facilities/{{ $pageFacilities->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/pages/facilities/{{ $pageFacilities->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'halaman sarana & prasarana ' . $pageFacilities->title . ''" :data="$pageFacilities">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            <a wire:navigate
                                                href="/admin/pages/facilities/{{ $pageFacilities->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate
                                                href="/admin/pages/facilities/{{ $pageFacilities->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $pageFacilities->title . ''" :data="$pageFacilities">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data halaman sarana & prasarana tidak tersedia. Silakan buat <a wire:navigate href="/admin/pages/facilities/create"
                                class="underline text-greenMain">halaman sarana & prasarana baru</a>.</h3>
                    </div>
                @endif
            </div>
        </div>
        <x-pagination :items="$pageFacilitiess" />
    </main>
</div>
