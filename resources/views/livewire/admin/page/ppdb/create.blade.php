<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Buat Halaman PPDB',
            'url' => '/admin/pages/ppdb/create',
        ],
    ]"></x-breadcrumb>
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <div class="flex items-center justify-center ">
                <div class="w-full mx-auto bg-white">
                    @if ($errors->any())
                        @if ($errors->has('category') && $errors->has('type'))
                            <p class="px-10 py-2 text-xs italic text-center text-red-500 bg-red-50 font-jakarta">Maaf,
                                anda tidak dapat membuat PPDB lagi karena PPDB hanya bisa dibuat satu kali, silakan edit
                                data PPDB yang sudah ada</p>
                        @endif
                    @endif
                    <form wire:submit='save'>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Buat PPDB</span>
