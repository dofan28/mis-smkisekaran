<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Mengelola Halaman PPDB',
            'url' => '/admin/pages/ppdb',
        ],
    ]"></x-breadcrumb>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/pages/ppdb/create"
                class="flex items-center px-3 py-2 space-x-2 font-semibold text-white transition duration-300 ease-in-out transform rounded-lg shadow-lg w-36 bg-amber-500 hover:bg-amber-700 hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                </svg>
                <span class="text-sm font-jakarta">Buat PPDB</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                @if ($pagePPDBs->isNotEmpty())
                    <!-- Desktop version -->
                    <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($pagePPDBs as $pagePPDB)
                                <tr wire:key='{{ $pagePPDB->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            ...
                                            <a wire:navigate href="/admin/pages/ppdb/{{ $pagePPDB->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'halaman PPDB ' . $pagePPDB->title . ''" :data="$pagePPDB">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            <a wire:navigate
                                                href="/admin/pages/ppdb/{{ $pagePPDB->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate
                                                href="/admin/pages/ppdb/{{ $pagePPDB->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $pagePPDB->title . ''" :data="$pagePPDB">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data halaman PPDB tidak tersedia. Silakan buat <a wire:navigate
                                href="/admin/pages/ppdb/create" class="underline text-greenMain">halaman
                                PPDB baru</a>.</h3>
                    </div>
                @endif
            </div>
        </div>
        <x-pagination :items="$pagePPDBs" />
    </main>
</div>
