<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Edit Halaman PPDB',
            'url' => '/admin/pages/ppdb/' . $pagePPDB->slug . '/edit',
        ],
    ]"></x-breadcrumb>
                ...
                <div class="w-full mx-auto bg-white">
                    @if ($errors->any())
                        @foreach ($errors->all() as $error)
                            <p class="text-xs italic text-center text-red-500 font-jakarta">{{ $error }}</p>
                        @endforeach
                    @endif
                    <form wire:submit='update'>
                        ...
                        <div>
                            <button wire:loading.class='bg-amber-700' wire:loading.attr='disabled' type="submit"
                                ...
                                <span wire:loading.remove>Edit Halaman PPDB</span>
