<div>
    ...
    <x-breadcrumb :breadcrumbs="[
        ...
        [
            'name' => 'Mengelola Halaman Profil Guru',
            'url' => '/admin/pages/teacher',
        ],
    ]"></x-breadcrumb>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/pages/teacher/create"
                class="flex items-center w-40 px-3 py-2 space-x-2 font-semibold text-white transition duration-300 ease-in-out transform rounded-lg shadow-lg bg-amber-500 hover:bg-amber-700 hover:scale-105">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                </svg>
                <span class="text-sm font-jakarta">Buat Profil Guru</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                @if ($pageTeachers->isNotEmpty())
                    <!-- Desktop version -->
                    <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        <thead class="text-white bg-greenMain font-merriweather">
                            <tr>
                                ...
                                <th class="w-1/2 px-4 py-3 font-bold text-left border border-gray-100">Deskripsi Guru
                                </th>
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($pageTeachers as $pageTeacher)
                                <tr wire:key='{{ $pageTeacher->id }}'
                                    ...
                                    <td class="flex justify-center px-4 py-3 border border-gray-100">
                                        <img src="{{ asset('storage/' . $pageTeacher->image) }}"
                                            class="object-cover object-center h-24 border-2 border-gray-400 rounded-md shadow-md"
                                            alt="{{ $pageTeacher->title }}">
                                    </td>
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/pages/teacher/{{ $pageTeacher->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/pages/teacher/{{ $pageTeacher->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'halaman profil guru ' . $pageTeacher->title . ''" :data="$pageTeacher">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            <a wire:navigate
                                                href="/admin/pages/teacher/{{ $pageTeacher->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate
                                                href="/admin/pages/teacher/{{ $pageTeacher->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $pageTeacher->title . ''" :data="$pageTeacher">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data halaman profil guru tidak tersedia. Silakan buat <a wire:navigate
                                href="/admin/pages/teacher/create" class="underline text-greenMain">halaman profil
                                guru baru</a>.</h3>
                    </div>
                @endif
            </div>
        </div>
        <x-pagination :items="$pageTeachers" />
    </main>
</div>
