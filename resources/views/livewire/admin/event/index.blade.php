<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/events/create"
                ...
                <span class="text-sm font-jakarta">Buat Kegiatan</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                ...
                <table class="hidden min-w-full bg-white border-separate border-spacing-0 sm:table">
                        <thead class="text-white bg-greenMain font-merriweather">
                            <tr>
                                <th class="w-1/6 px-4 py-3 font-bold text-left border border-gray-100 rounded-tl-lg">
                                    Judul</th>
                                <th class="w-1/2 px-4 py-3 font-bold text-left border border-gray-100">Deskripsi</th>
                                <th class="w-1/6 px-4 py-3 font-bold text-left border border-gray-100">
                                    Tgl. Mulai</th>
                                <th class="px-4 py-3 font-bold text-left border border-gray-100 ">Gambar</th>
                                <th class="w-2/12 px-4 py-3 font-bold text-left border border-gray-100">Status</th>
                                <th class="px-4 py-3 font-bold text-left border border-gray-100 rounded-tr-lg">Aksi</th>
                            </tr>
                        ...
                        <tbody class="text-gray-800">
                            @foreach ($events as $event)
                                <tr wire:key='{{ $event->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="line-clamp-2">{{ $event->date }}</div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/events/{{ $event->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/events/{{ $event->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'kegiatan ' . $event->title . ''" :data="$event">
                     ...
                     <div class="sm:hidden">
                        @foreach ($events as $event)
                            <div class="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                <div class="p-4">
                                    <h3 class="mb-2 text-lg line-clamp-2 font-semibold text-gray-800">{{ $event->title }}</h3>
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $event->title . ''" :data="$event">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data kegiatan tidak tersedia. Silakan buat <a wire:navigate href="/admin/events/create"
                                class="underline text-greenMain">kegiatan baru</a>.</h3>
                    </div>
                @endif
            </div>
