<div>
    ...
    <main class="py-10">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            <a wire:navigate href="/admin/galleries/create"
                ...
                <span class="text-sm font-jakarta">Buat Galeri</span>
            </a>
            <div class="mt-5 overflow-x-auto">
                                ...
                                <tr wire:key='{{ $gallery->id }}'
                                    ...
                                    <td class="px-4 py-3 border border-gray-100">
                                        <div class="inline-flex items-center rounded-md shadow-sm">
                                            <a wire:navigate href="/admin/galleries/{{ $gallery->slug }}/edit">
                                                <button
                                            ...
                                            <a wire:navigate href="/admin/galleries/{{ $gallery->slug }}">
                                                <button
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'galeri ' . $gallery->title . ''" :data="$gallery">
                    ...
                    <div class="sm:hidden">
                        @foreach ($galleries as $gallery)
                            <div class="mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                <div class="p-4">
                                    <h3 class="mb-2 text-lg line-clamp-2 font-semibold text-gray-800">{{ $gallery->title }}</h3>
                                    ...
                                    <div class="flex items-center justify-center mt-3">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <x-modal-confirmation action="delete" :identify="'pengumuman ' . $gallery->title . ''" :data="$gallery">
                                                <button @click="showModal = true"
                ...
                @else
                    <div class="text-center text-gray-800 font-jakarta">
                        <h3>Data galeri tidak tersedia. Silakan buat <a wire:navigate href="/admin/galleries/create"
                                class="underline text-greenMain">galeri baru</a>.</h3>
                    </div>
                @endif
            </div>

        </div>
        <x-pagination :items="$galleries" />
    </main>
</div>
